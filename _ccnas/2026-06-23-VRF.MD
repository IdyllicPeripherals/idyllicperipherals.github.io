...
<body>
    ...
    <div class="question">
        <label for="q0">Create a VRF for [name]:</label>
    ...
    <div class="question">
        <label for="q3">Assign an interface to VRF [name]:</label>
    ...
    <div class="question">
        <label for="q2">Show the routing table for VRF [name]:</label>
    ...
    <div class="question">
        <label for="q1">Ping the ip address 192.168.10.1 in VRF [name]:</label>
    ...
    <script>
        const answers = {
            'q0': 'ip vrf vrf-name',
            'q1': 'ping vrf vrf-name 192.168.10.1',
            'q2': 'show ip route vrf vrf-name',
            'q3': 'ip vrf forwarding vrf-name',
        };
